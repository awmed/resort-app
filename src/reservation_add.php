...
<?php require 'inc/_global/views/head_start.php'; 
	echo '<title> ADD RESERVATION </title>'
?>
...
<div class="content">
    <nav class="breadcrumb bg-white push">
        ...
        <span class="breadcrumb-item active">ADD RESERVATION</span>
    </nav>
    <div class="block">
        <div class="block-header block-header-default">
            <h2 class="block-title" style="font-size:25px"><strong>ADD RESERVATION</strong></h2>
        </div>
        <div class="block-content">
        <div class="row justify-content-center py-20">
                <div class="col-xl-5">
                    <form action="inc\backend\database\reservation_add.php" method="post">
                        <!-- row -->
                        <div class="form-group">
                            ...
                            try {
                                ...
                                $sql = "SELECT res_id FROM reservation ORDER BY res_id ASC;";
                        ...
                        <!-- row -->
                        <div class="form-group">
                            <button type="submit" name="add-reservation" class="btn btn-alt-primary btn-rounded" data-toggle="click-ripple"><i class="fa fa-plus mr-5"></i>Add Reservation</button>
                        </div>
                        <!-- end row -->                       
                    </form>
                    <!-- end form -->
