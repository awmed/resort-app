...
<?php require 'inc/_global/views/head_start.php'; 
	echo '<title> CUSTOMER PROFILE </title>'
?>
...
<div class="content">
    ...
    <div class="block">
        ...
        <h2 class="block-title" style="font-size:25px"><strong> CUSTOMER PROFILE </strong></h2>
        </div>
                            ...
                            <div>                                
                                ...
                                if($gen=='Male') {
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline mb-5">
                                        <input class="custom-control-input" type="radio" name="gender" id="male" value="Male" checked disabled>
                                ...
                                if($gen=='Female') {
                                    echo '
                                    <div class="custom-control custom-radio custom-control-inline mb-5">
                                        <input class="custom-control-input" type="radio" name="gender" id="female" value="Female" checked disabled>
                        ...
                        <div class="form-group">
                            ...
                            <div>                                
                                ...
                                if($nat=='Sri Lankan') {
                                    echo '
                                    <div class="custom-control custom-radio custom-control-inline mb-5">
                                        <input class="custom-control-input" type="radio" name="nationality" id="nationality1" value="Sri Lankan" checked disabled>
                                ...
                                if($nat=='Non Sri Lankan') {
                                    echo '
                                    <div class="custom-control custom-radio custom-control-inline mb-5">
                                        <input class="custom-control-input" type="radio" name="nationality" id="nationality2" value="Non Sri Lankan" checked disabled>
