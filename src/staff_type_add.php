...
'<script>                     
    setTimeout(function() {
        swal({
            title: "Success",
            text: "Staff Type Added Successfully !",
            type: "success"
        })
    }, 100);
</script>';
...
<?php require 'inc/_global/views/head_start.php'; 
	echo '<title> ADD STAFF TYPE </title>'
?>
...
<div class="content">
    <nav class="breadcrumb bg-white push">
        ...
        <span class="breadcrumb-item active">ADD STAFF TYPE</span>
    </nav>
    <div class="block">
        <div class="block-header block-header-default">
            <h2 class="block-title" style="font-size:25px"><strong>ADD STAFF TYPE</strong></h2>
        </div>
        <div class="block-content">
            <div class="row justify-content-center py-20">
                <div class="col-xl-5">
                    <form action="inc\backend\database\staff_type_add.php" method="post">
                        <!-- row -->
                        <div class="form-group ">
                            <label for="example-text-input">Staff Type ID</label>
                                ...
                                try {
                                    ...
                                    $sql = "SELECT s_type_id FROM staff_type ORDER BY s_type_id ASC;";
                        ...
                        <!-- row -->
                        <div class="form-group">
                            <label for="example-text-input">Staff Type <span class="text-danger">*</span></label>
                        ...
                        <!-- row -->
                        <div class="form-group">
                            <button type="submit" id="submit" name="submit" class="btn btn-alt-primary btn-rounded" data-toggle="click-ripple"><i class="fa fa-plus mr-5"></i>Add Type</button>
                        </div>
                        <!-- end row -->                       
                    </form>
                    <!-- end form -->
