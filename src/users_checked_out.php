...
<?php require 'inc/_global/views/head_start.php'; 
	echo '<title> USERS CHECKED OUT </title>'
?>
...
<div class="content">
    <nav class="breadcrumb bg-white push d-print-none">
        ...
        <span class="breadcrumb-item active"> USERS CHECKED OUT </span>
    </nav>
    <div class="block">
        <div class="block-header block-header-default">
            <h2 class="block-title d-print-none" style="font-size:25px"><strong> USERS CHECKED OUT </strong></h2>
                        ...
                        try {
                            ...
                            if(!@mysqli_stmt_prepare($stmt, $sql)) {
                                ...
                                while($row=mysqli_fetch_array($result)) {
                                    echo ('
                                    <tr>
                                        <td class="text-center">'.$row["out_id"].'</td>
